...
function init() {
  ...
  var translations = {
    ...
    ,'Target bg range bottom' : {
      ...
      ,ru: 'Нижнее значение диапазона СК'
      }
    ,'top' : {
      cs: 'horní'
      ,de: 'oben'
...
// food editor
    ...
    ,'Insulin Cartridge Change' : {
      ...
      ,ru: 'Замена инсулинового картриджа'
      }
    ,'D.A.D. Alert' : {
      cs: 'D.A.D. Alert'
    ...
    ,'Reset, and use defaults' : {
      ...
      ,ru: 'Сбросить на настройки по умолчанию'
      }
    ,'Calibrations' : {
      cs: 'Kalibrace'
      ,de: 'Kalibrierung'
