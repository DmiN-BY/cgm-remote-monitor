...
function init() {
  ...
  var translations = {
    ...
    ,'Loading CGM data of' : {
      ...
      ,ru: 'Загрузка данных мониторинга от'
      }
...
// ported reporting
    ...
    ,'There is not sufficient data to run this report. Select more days.' : {
      ...
      ,ru: 'Недостаточно данных для формирования отчета. Выберите больше дней'
	  }
// food editor
    ,'Using stored API secret hash' : {
      ...
      ,ru: 'Используя сохранненый хэш ключа API'
      }
    ,'No API secret hash stored yet. You need to enter API secret.' : {
      ...
      ,ru: 'Еще нет сохраненного хэша ключа API. Вам надо ввести значение ключа API'
      }
    ,'Database loaded' : {
      cs: 'Databáze načtena'
    ...
    ,'Error: Database failed to load' : {
      ...
      ,ru: 'Ошибка: База данных не загружена'
      }
    ,'Create new record' : {
    ...
    ,'Your API secret must be at least 12 characters long' : {
      ...
      ,ru: 'Ваш ключ API должен содержать как минимум 12 символов'
      }
    ,'Bad API secret' : {
      cs: 'Chybné API heslo'
    ...
    ,'Store hash on this computer (Use only on private computers)' : {
      ...
      ,ru: 'Сохранить хэш ключа API на этом компьютере (Используйте только на личных компьютерах)'
      }
    ,'Treatments' : {
      cs: 'Ošetření'
      ,de: 'Bearbeitung'
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,ru: 'Пожалуйста убедитесь в корректности введенных данных'
      }
    ,'BG' : {
      cs: 'Glykémie'
      ,de: 'Blutglukose'
    ...
    ,'Use BG correction in calculation' : {
      ...
      ,ru: 'Учитывать коррекцию СК при рассчетах'
      }
    ,'BG from CGM (autoupdated)' : {
      ...
      ,ru: 'СК по данным системы мониторинга (автоматически)'
      }
    ,'BG from meter' : {
    ...
    ,'Use carbs correction in calculation' : {
      ...
      ,ru: 'Учитывать коррекцию углеводов при расчете'
      }
    ,'Use COB correction in calculation' : {
      ...
      ,ru: 'Учитывать COB коррекцию при расчете'
      }
    ,'Use IOB in calculation' : {
      ...
      ,ru: 'Учитывать IOB коррекцию при рассчете'
      }
    ,'Other correction' : {
      cs: 'Jiná korekce'
    ...
    ,'Enter insulin correction in treatment' : {
      ...
      ,ru: 'Введите коррекцию инсулина в событии'
      }
    ,'Insulin needed' : {
      cs: 'Potřebný inzulín'
    ...
    ,'Carbs needed if Insulin total is negative value' : {
      ...
      ,ru: 'Потребность в углеводах, если Инсулина всего - отрицательное значение'
      }
    ,'Basal rate' : {
      cs: 'Bazál'
      ,de: 'Basalrate'
    ...
    ,'Additional Notes, Comments' : {
      ...
      ,he: 'הערות נוספות'
      ,ru: 'Дополнительные заметки, комментарии'
      }
    ,'RETRO MODE' : {
      cs: 'V MINULOSTI'
      ,de: 'RETRO MODUS'
    ...
    ,'Add food from your database' : {
      ...
      ,ru: 'Добавить еду из вашей базы данных'
      }
    ,'Reload database' : {
      ...
      ,ru: 'Перезагрузить данные из базы'
      }
    ,'Add' : {
      cs: 'Přidej'
      ,de: 'Hinzufügen'
    ...
    ,'Entering record failed' : {
      ...
      ,nb: 'Lagring feilet'
      ,ru: 'Введенная запись некорректна'
      }
    ...
    ,'Your device is not authenticated yet' : {
      ...
      ,ru: 'Ваше устройство еще не допущено'
      }
    ,'Sensor' : {
      cs: 'Senzor'
      ,de: 'Sensor'
    ...
    ,'Logarithmic (Dynamic)' : { 
      ...
      ,ru: 'Логарифмическая (Динамически)'
      }
    ...
    ,'Insulin Cartridge Change' : {
      ...
      ,ru: 'Замена картриджа для инсулина'
      }
    ,'D.A.D. Alert' : {
      cs: 'D.A.D. Alert'
    ...
    ,'When enabled an alarm may sound.' : {
      ...
      ,ru: 'Когда предупреждение активно, может раздаваться звук'
      }
    ,'Urgent High Alarm' : {
    ...
    ,'Stale Data: Warn' : {
      ...
      ,ru: 'Устаревшие данные: Предупреждение'
      }
    ,'Stale Data: Urgent' : {
    ...
    ,'When enabled the page will be dimmed from 10pm - 6am.' : {
      ...
      ,ru: 'Когда активен, то яркость страницы будет уменьшена с 22:00 до 6:00'
      }
    ,'Enable' : {
      cs: 'Povoleno'
      ,de: 'Eingeschaltet'
    ...
    ,'Show Raw BG Data' : {
      ...
      ,nb: 'Vis rådata'
      ,ru: 'Показывать необработанные данные СК'
      }
    ,'Never' : {
      cs: 'Nikdy'
      ,de: 'Nie'
    ...
    ,'When enabled small white dots will be displayed for raw BG data' : {
      ...
      ,ru: 'Когда активен, то необработанные данные СК будут показаны белыми маленькими точками'
      }
    ,'Custom Title' : {
    ...
    ,'Reset, and use defaults' : {
      ...
      ,ru: 'Сброс на настройки по умолчанию'
      }
    ,'Calibrations' : {
      cs: 'Kalibrace'
      ,de: 'Kalibrierung'
    ...
    ,'Alarm Test / Smartphone Enable' : {
      ...
      ,ru: 'Тест тревоги / Смартфон активен'
      }
    ,'Bolus Wizard' : {
    ...
    ,'Remove future items from mongo database' : {
      ...
      ,ru: 'Удалить записи с датой в будущем из базы данных Mongo'
      }
    ,'Find and remove treatments in the future' : {
      ...
      ,ru: 'Найти и удалить события с датой в будущем'
      }
    ,'This task find and remove treatments in the future.' : {
      ...
      ,ru: 'Задача для поиска и удаления событий с датой в будущем'
      }
    ,'Remove treatments in the future' : {
      ...
      ,ru: 'Удалить события с датой в будущем'
      }
    ,'Find and remove entries in the future' : {
      ...
      ,ru: 'Найти и удалить записи с датой в будущем'
      }
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,ru: 'Задача для поиска и удаления данных мониторинга с датой в будущем, ошибочно созданных при загрузке'
      }
    ,'Remove entries in the future' : {
      ...
      ,ru: 'Удалить записи с датой в будущем'
      }
    ,'Loading database ...' : {
    ...
    ,'Database contains %1 future records' : {
      ...
      ,ru: 'В базе данных содержится %1 записей, имеющих дату в будущем'
      }
    ...
    ,'Clean Mongo status database' : {
      ...
      ,ru: 'Очистить базу данных статусов'
      }
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,ru: 'Удалить все документы из коллекции devicestatus'
      }
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,ru: 'Задача удаляет все документы из коллекции devicestatus. Полезна если battery status не был успешно обновлен.'
      }
    ...
    ,'Loading temp basal data' : {		
      ...
      ,ru: 'Загрузка данных для временного базала'
      }
