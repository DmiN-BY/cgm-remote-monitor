...
// food editor
    ...
    ,'Stale Data: Warn' : {
      ...
      ,ru: 'Устар. данные: Предупреждение'
      }
    ,'Stale Data: Urgent' : {
    ...
    ,'Reset, and use defaults' : {
      ...
      ,ru: 'Сбросить на стандартные настройки'
      }
    ,'Calibrations' : {
      cs: 'Kalibrace'
      ,de: 'Kalibrierung'
